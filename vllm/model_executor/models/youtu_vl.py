...
class YoutuVLForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP, SupportsLoRA):
    """
    YoutuVL: Native vLLM unified multimodal model.
...
class YoutuVLLayoutParser:
    ...
    LAYOUT_TYPES = {
        ...
        "LAYOUT_SEAL", "LAYOUT_FOOTER_FIGURE", "LAYOUT_HEADER_FIGURE", 
        "LAYOUT_CHART_LOGIC", "LAYOUT_CHART_DATA", "LAYOUT_SIGNATURE"
    }
    ...
    # Prompt templates
    LAYOUT_PROMPT = "Analyze the layout structure of the input document, detect all structural elements and classify them semantically. Use \n to delimit different regions."
    
    # OCR prompt prefix
    OCR_PROMPT_PREFIX = "Based on the given input field coordinates and layout type, identify and extract the content within the specified region. Formulas shall be represented in LaTeX notation, and tables shall be structured in OTSL format: "
